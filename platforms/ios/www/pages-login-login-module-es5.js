...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
  ...
  /***/
  function srcAppPagesLoginLoginCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesLoginLoginTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginPage(userData, router, api, storage) {
        ...
        this.login = {};
        this.wrongpassword = false; // login: UserOptions = { username: '', password: '' };
      ...
      _createClass(LoginPage, [{
        ...
        value: function onLogin(form) {
          ...
          if (form.valid) {
            this.api.loginPost(this.login).then(function (res) {
              console.log(res);
              ...
              if (res && res.token) {
                ...
                _this.api.login(loginData).then(function (res) {
                  console.log(_this.login);

                  if (res.status == 'success') {
                    _this.storage.setData({
                      token: res.token,
                      userType: res.userType
                    });

                    _this.router.navigateByUrl('/app/tabs/dashboard');
                  } else {
                    console.log("failuer");
    ...
    LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! ./login.css */
      "./src/app/pages/login/login.css")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_providers_user_data__WEBPACK_IMPORTED_MODULE_5__["UserData"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _service_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _service_storage_service_service__WEBPACK_IMPORTED_MODULE_4__["StorageServiceService"]])], LoginPage);
    /***/
  }
}]);
